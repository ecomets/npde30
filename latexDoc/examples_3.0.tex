...
\par\kern -0.3cm
\begin{center}
\epsfig{file=/home/eco/work/npde/doclib/figs/theophylline.eps,width=12cm}
\end{center}
...
\par\kern -1cm
\begin{center}
\epsfig{file=/home/eco/work/npde/doclib/figs/doc_warfarin_data.eps,width=6cm,angle=0}
\end{center}
\par\kern -6.5cm
...
\hline 
& \multicolumn{2}{c}{Base model} &  \multicolumn{2}{c}{Covariate model} \\
...
\par\kern -1cm
\begin{center}
\epsfig{file=/home/eco/work/npde/doclib/figs/doc_warfarin_basewaffle.eps,width=6cm,angle=0}
\end{center}
\par\kern -6.5cm
...
\par\kern -1cm
\begin{center}
\epsfig{file=/home/eco/work/npde/doclib/figs/doc_warfarin_covwaffle.eps,width=6cm,angle=0}
\end{center}
\par\kern -6.5cm
...
\hskip 18pt The plots above can be split by covariate. For instance, 
