...
\hskip 18pt  This is the User's guide for the add-on package {\sf npde} (version 3.0, September 2020) for the {\sf R} language. It is distributed in the \texttt{inst} directory of the package. Version 3.0 includes a complete overhaul of the graphs, which have been moved to the {\sf ggplot2} philosophy~\cite{ggplot2} by Romain Leroux.
