...
# File too large
if(FALSE) {
  cmd<-paste("cp ", file.path(workDir,"latexDoc","userguide_3_3.pdf")," ", file.path(compilDir,"inst","userguide_npde_3.3.pdf"),sep="")
  system(cmd)
}
...
system("R CMD check --as-cran --run-donttest npde_3.3.tar.gz")
```
...
install.packages(pkgs=file.path(compilDir,"npde_3.3.tar.gz"),repos=NULL)
library(npde)
library(ggplot2)
library(gridExtra)
library(mclust)
