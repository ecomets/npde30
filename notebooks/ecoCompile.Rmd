---
title: "Package compilation and basic run - current version 3.5"
...
# File too large
if(FALSE) {
  cmd<-paste("cp ", file.path(workDir,"latexDoc","userguide_3_3.pdf")," ", file.path(compilDir,"inst","userguide_npde_3.5.pdf"),sep="")
  system(cmd)
}
...
system("R CMD check --as-cran --run-donttest npde_3.5.tar.gz")
```
...
install.packages(pkgs=file.path(compilDir,"npde_3.5.tar.gz"),repos=NULL)
library(npde)
library(ggplot2)
library(gridExtra)
library(mclust)
