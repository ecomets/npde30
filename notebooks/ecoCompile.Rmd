...
# File too large
if(FALSE) {
  cmd<-paste("cp ", file.path(workDir,"latexDoc","userguide_3_1.pdf")," ", file.path(compilDir,"inst","userguide_npde_3.1.pdf"),sep="")
  system(cmd)
}
...
system("R CMD check --as-cran --run-donttest npde_3.2.tar.gz")
```
