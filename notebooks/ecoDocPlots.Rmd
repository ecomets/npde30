...
libDir<-"/home/eco/work/npde/compileNpde"
...
install.packages(pkgs=file.path(libDir,"npde_3.3.tar.gz"),repos=NULL)
library(npde)
```
...
# yobs versus covariate
# npde.plot.scatterplot(wcov, which.x="cov", which.y="yobs", which.cov="age")
