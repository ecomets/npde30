...
This is a snapshot of the version of npde released at the time of the revision of the paper submitted to AAPS Journal. We use development mode to avoid messing up any existing installation of npde.

```{r devModeInstall}
dev_mode() # development mode
install.packages(pkgs="/home/eco/work/npde/npde30/npde_3.0.tar.gz",repos=NULL)
library(npde)
```
...
yvir<-autonpde(virload,simvirload,iid=1,ix=2,iy=3,boolsave=FALSE, units=list("hr","cp/mL, log 10 base"))
